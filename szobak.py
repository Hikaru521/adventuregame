...
rooms = {"szoba3_2": Room(3, 2, "\n-------------------------------------STORY--------------------------------------",
                          Dialog("2043-at irunk, pár éve a földön egy furcsa virus ütötte fel a fejét",
                          ...
                          "--------------------------------------------------------------------------------",None ,  True),
         "szoba3_4": Room(3, 4, "\n-------------------------------------STORY--------------------------------------" ,
                          Dialog("A furcsa hang egy romos helyiségbe vezetett téged ahova szépen óvatosan belépve látod hogy a romok túloldalán katonák beszélgetnek.",
...
"--------------------------------------------------------------------------------",
         ...
         "szoba3_6": Room(3, 6, "\n-------------------------------------STORY--------------------------------------",
                          Dialog("Beléptél egy étkezőnek tűnő alig felismerhető helyiségbe!",
                          ...
                          "----------------------------------------------------------------------------------------------------------------",None ),
         "szoba2_2":Room(2,2, "\n-------------------------------------STORY--------------------------------------" ,
                         Dialog("Beléptél a hosszú, egyenes és sötét folyosóra.",
                         ...
                         "--------------------------------------------------------------------------------",None ),
         "szoba2_4": Room(2, 4,"\n-----------------------------------------------STORY-----------------------------------------------",
                          Dialog("Beléptél egy koszos, poros, romos raktárba aminek lyukacsos falain átlátva látod túloldalt a fényt.",
                          ...
                          "---------------------------------------------------------------------------------------------------",None ),
         "szoba2_6": Room(2, 6,"\n----------------------------------------------STORY-----------------------------------------------",
                          Dialog("A szoba elejéből ami egy irodának tűnik, látod hogy éppen menne ki valaki és az állata a szobából.",
         ...
         "szoba1_2":Room(1,2,"\n------------------------------------------------STORY-----------------------------------------------" ,
                         Dialog("A következő szobába érve furcsa morgás szerű hangokra leszel figyelmes.",
         ...
         "szoba1_4":Room(1, 4,"\n------------------------------------------------STORY-----------------------------------------------" ,
                         Dialog("Egy kisebb folyosó végére érve egy orvosi szobát találsz.",
                         ...
                         "----------------------------------------------------------------------------------------------------",None ),
         "szoba1_6":Room(1, 6, "\n----------------------------------------------------STORY----------------------------------------------------",
                         Dialog("A titokzatos alak után sietve látod ahogyan éppen az udvar közepén áll és rád néz!",
